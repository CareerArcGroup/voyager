...
require 'voyager/clients/linked_in_client_v1'
require 'voyager/clients/linked_in_client_v2'
require 'voyager/clients/facebook_client'
require 'voyager/clients/slack_client'
require 'voyager/clients/instagram_client'
...
require 'voyager/parsers/instagram_parser'
